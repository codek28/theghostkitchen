...
// Fine-Dine Category Schema is for dishes available on Fine-Dine Centers by pre-booking.

const FineDineCategorySchema = new mongoose.Schema({
  ...
  module.exports = mongoose.model("finedinecategories", FineDineCategorySchema);