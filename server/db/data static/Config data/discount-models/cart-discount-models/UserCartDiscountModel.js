...
const UserCartDiscountSchema = new mongoose.Schema({
    Code:{type: String, required:true, unique:true},
    DiscountType:{type: String, required:true, default:"USER-COUPON"}, // Includes - Global-Coupon/Zone-Coupon/CheckIn-Coupon/User-Coupon/Admin-Applied
...
module.exports = mongoose.model("discount.cartdiscount.userdiscounts",UserCartDiscountSchema);