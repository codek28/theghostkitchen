...
const AdminCartDiscountSchema = new mongoose.Schema({
  Code: { type: String, required: true, unique: true },
  DiscountType: { type: String, required: true, default: "ADMIN-COUPON" }, // Includes - Global-Coupon/Zone-Coupon/CheckIn-Coupon/User-Coupon/Admin-Applied
...
module.exports = mongoose.model(
  "discount.cartdiscount.admindiscounts",
  AdminCartDiscountSchema
);
