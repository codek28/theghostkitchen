...
// schema for online selling combo food / thaali / mess products

const CombinationProductSchema = new mongoose.Schema({
  ...
  module.exports = mongoose.model("combinationproducts", CombinationProductSchema);