...
// Mess Category Schema is for packages available for online/offline selling
// Subscription management included

const MessCategorySchema = new mongoose.Schema({
    ...
    SubscriptionDetails: {
      MealType: [String], // It could included Breakfast,Brunch,Lunch,Supper,Dinner
    },
    CategoryVisibilityStatus: { type: Boolean },
    CategoryKeywords: [String],
    Illustration: {},
  });
  
  module.exports = mongoose.model("messcategories", MessCategorySchema);